        ...
        <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
          <div className="text-center my-5">
            <div className="relative mx-auto  sm:w-3/4 mt-5">
              <input
                id="input"
                className="px-4 py-2 sm:w-40 md:w-96 lg:w-full xl:w-full  text-black rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-200"
                type="text"
                id="gccp_search"
                value={filter}
