...
import DancingMan from "./assets/DancingMan.gif";
        ...
        <div className="overflow-x-auto">
          <div className="mb-4">
            ...
            <div className="ml-44 relative">
              ...
              <img
                className="absolute right-0 top-0 m h-32 w-32 mr-18"
                style={{ top: "-64px" }}
                src={
                  totalCompletion >= 40
                    ? DancingMan
                    : "https://cdn-icons-png.flaticon.com/512/4033/4033298.png"
                }
                alt="Prize"
              />
              <p className="text-center text-white ml-[900px] mt-12 ">
                T shirts and stickers(Swags)
              </p>
            </div>
            <p className="text-center text-white py-4 text-4xl">
              <mark
                className={`px-4 text-white ${
                  remainingCompletion <= 0 ? "bg-green-600" : "bg-red-600"
                } rounded mr-4 `}
              >
                {remainingCompletion <= 0 ? 0 : remainingCompletion}
              </mark>{" "}
              completions are required to cross tier 3
            </p>
          </div>
